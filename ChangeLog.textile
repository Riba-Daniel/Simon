...
* Added handlers for UIButtons and UILabels so that the print tree function could work better.
* Added label text, button titles, UIView tags, accessibilityIdentifiers and labels as attributes to be printed.
