...
* Added a --noautorun program argument which can be used to stop the stories from running on startup.
* Added a --noload program argument which stops Simon from loading. Really useful for unit testing Simon. Not much else.
