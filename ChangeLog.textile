...
---
h1. Version 0.1.8, March 2012

* Switched to only building for armv7 devices instea of both armv6 and armv7.
...
* Added ability to rerun all tests and search result tests.
