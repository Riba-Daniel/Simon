...
First there are three frameworks you need to download. They are:

* "Simon framework":http://github.com/drekka/Simon
* "dUsefulStuff framework":http://github.com/drekka/dUsefulStuff - version 0.0.11+
* "dXPath framework":http://github.com/drekka/dXpath - version 0.1.0+
...
Simon makes it very simple to access any UIView instance on the display. Here's an example which returns a button. Lets say you have a UI hirachy that looks something like this:
