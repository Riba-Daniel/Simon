...
* "dUsefulStuff framework":http://github.com/drekka/dUsefulStuff - version 0.0.12+ (Provides some common code I use)
* "dNodi framework":http://github.com/drekka/dNodi - version 0.2.1+ (Provides XPath like searching)
