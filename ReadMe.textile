...
| SIAssertTrueM(expr, message) | Fails if the expression results in NO and uses the passed message. |
| SIAssertFalse(expr) | Fails if the expression results in YES. |
| SIAssertFalseM(expr, message) | Fails if the expression results in YES and uses the passed message. |
